const OXBLOOD={id:"oxblood",vars:{"--bg":"#08080a","--bg-2":"#0d0d10","--paper":"#d8d4cb","--paper-2":"#9a958a","--paper-3":"#5b574f","--paper-4":"#2c2a26","--rule":"#1a1a1e","--rule-2":"#232227","--accent":"#a32733","--accent-deep":"#5b1820","--accent-ink":"#c34050"}};function useReveal(r){React.useEffect(()=>{let a=0;const e=()=>{const o=window.innerHeight||800;document.querySelectorAll("[data-reveal]:not(.is-in)").forEach(i=>{i.getBoundingClientRect().top<o*.92&&i.classList.add("is-in")})},t=()=>{cancelAnimationFrame(a),a=requestAnimationFrame(e)};e();const n=setTimeout(e,60),c=setTimeout(e,320);return window.addEventListener("scroll",t,{passive:!0}),window.addEventListener("resize",t),()=>{window.removeEventListener("scroll",t),window.removeEventListener("resize",t),clearTimeout(n),clearTimeout(c),cancelAnimationFrame(a)}},[r])}function GlobalStyle(){return React.createElement("style",null,`
    ...
    `)}const CD_NAV=[{key:"index",label:"Index",href:"#/"},{key:"projects",label:"Projects",href:"#/projects"},{key:"notes",label:"Field Notes",href:"#/field-notes"},{key:"trajectory",label:"Trajectory",href:"#/trajectory"},{key:"about",label:"About",href:"#/about"},{key:"hire",label:"AOI / Hire",href:"#/hire"}];function StatusClock(){const[r,a]=React.useState(()=>new Date);React.useEffect(()=>{const s=setInterval(()=>a(new Date),1e3);return()=>clearInterval(s)},[]);const e=r.toISOString(),t=e.slice(11,19),n=e.slice(0,10).replace(/-/g,"."),c=r.toLocaleTimeString("en-US",{hour12:!1,timeZoneName:"short"}),o=c.match(/^(\d{1,2}:\d{2}:\d{2})\s+(.+)$/),i=o?o[1].padStart(8,"0"):c,p=o?o[2]:"LOCAL",l=r.getFullYear()+"."+String(r.getMonth()+1).padStart(2,"0")+"."+String(r.getDate()).padStart(2,"0");return React.createElement("div",{className:"stamp clock"},React.createElement("div",null,React.createElement("span",{className:"z"},"UTC"),React.createElement("span",{className:"v"},t)," \xB7 ",n),React.createElement("div",null,React.createElement("span",{className:"z lo"},p),React.createElement("span",{className:"v"},i)," \xB7 ",l))}function StatusBar({station:r,cur:a}){return React.createElement(React.Fragment,null,React.createElement("div",{className:"cd-status"},React.createElement("div",{className:"station"},r," ",React.createElement("span",{className:"a"},"/")," ALI TAHIR"),React.createElement("div",null),a==="hire"?React.createElement("div",{className:"pill"},"OPEN \xB7 AI ENGINEERING"):React.createElement("div",null),React.createElement(StatusClock,null)),React.createElement("div",{className:"cd-rule thick"}),React.createElement("nav",{className:"cd-nav"},React.createElement("span",{className:"lbl"},"CHANNELS"),CD_NAV.map(e=>React.createElement("a",{key:e.key,className:a===e.key?"cur":"",href:e.href},e.label))))}function Foot({left:r,ack:a}){return React.createElement("div",{className:"cd-foot"},React.createElement("div",{className:"left"},r),React.createElement("div",{className:"links"},React.createElement("a",{href:"mailto:ali@pakfro.dev"},"ali@pakfro.dev"),React.createElement("a",{href:"https://github.com/alitahir6001",target:"_blank",rel:"noopener noreferrer"},"github"),React.createElement("a",{href:"https://linkedin.com/in/ali-t-06748432",target:"_blank",rel:"noopener noreferrer"},"linkedin")),React.createElement("div",{className:"right"},a))}Object.assign(window,{OXBLOOD,useReveal,GlobalStyle,StatusBar,Foot});
