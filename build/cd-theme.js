const OXBLOOD={id:"oxblood",vars:{"--bg":"#08080a","--bg-2":"#0d0d10","--paper":"#d8d4cb","--paper-2":"#9a958a","--paper-3":"#5b574f","--paper-4":"#2c2a26","--rule":"#1a1a1e","--rule-2":"#232227","--accent":"#a32733","--accent-deep":"#5b1820","--accent-ink":"#c34050"}};function useReveal(a){React.useEffect(()=>{let r=0;const e=()=>{const n=window.innerHeight||800;document.querySelectorAll("[data-reveal]:not(.is-in)").forEach(o=>{o.getBoundingClientRect().top<n*.92&&o.classList.add("is-in")})},t=()=>{cancelAnimationFrame(r),r=requestAnimationFrame(e)};e();const p=setTimeout(e,60),i=setTimeout(e,320);return window.addEventListener("scroll",t,{passive:!0}),window.addEventListener("resize",t),()=>{window.removeEventListener("scroll",t),window.removeEventListener("resize",t),clearTimeout(p),clearTimeout(i),cancelAnimationFrame(r)}},[a])}function GlobalStyle(){return React.createElement("style",null,`
    ...
    `)}const CD_NAV=[{key:"index",label:"Index",href:"#/"},{key:"projects",label:"Projects",href:"#/projects"},{key:"notes",label:"Field Notes",href:"#/field-notes"},{key:"trajectory",label:"Trajectory",href:"#/trajectory"},{key:"about",label:"About",href:"#/about"},{key:"hire",label:"AOI / Hire",href:"#/hire"}];function StatusClock(){const[a,r]=React.useState(()=>new Date);React.useEffect(()=>{const t=setInterval(()=>r(new Date),1e3);return()=>clearInterval(t)},[]);const e=a.toISOString();return React.createElement(React.Fragment,null,React.createElement("div",{className:"stamp"},"UTC",React.createElement("span",{className:"v"},e.slice(11,19))),React.createElement("div",{className:"stamp"},"DATE",React.createElement("span",{className:"v"},e.slice(0,10).replace(/-/g,"."))))}function StatusBar({station:a,cur:r}){return React.createElement(React.Fragment,null,React.createElement("div",{className:"cd-status"},React.createElement("div",{className:"station"},a," ",React.createElement("span",{className:"a"},"/")," ALI TAHIR"),React.createElement("div",null),React.createElement("div",{className:"pill"},"OPEN \xB7 MID-LEVEL SWE"),React.createElement(StatusClock,null)),React.createElement("div",{className:"cd-rule thick"}),React.createElement("nav",{className:"cd-nav"},React.createElement("span",{className:"lbl"},"CHANNELS"),CD_NAV.map(e=>React.createElement("a",{key:e.key,className:r===e.key?"cur":"",href:e.href},e.label))))}function Foot({left:a,ack:r}){return React.createElement("div",{className:"cd-foot"},React.createElement("div",{className:"left"},a),React.createElement("div",{className:"links"},React.createElement("a",{href:"mailto:ali@pakfro.dev"},"ali@pakfro.dev"),React.createElement("a",{href:"https://github.com/alitahir6001",target:"_blank",rel:"noopener noreferrer"},"github"),React.createElement("a",{href:"https://linkedin.com/in/ali-t-06748432",target:"_blank",rel:"noopener noreferrer"},"linkedin")),React.createElement("div",{className:"right"},r))}Object.assign(window,{OXBLOOD,useReveal,GlobalStyle,StatusBar,Foot});
